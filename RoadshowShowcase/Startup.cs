...
using RoadshowShowcase.Resolvers;
using RoadshowShowcase.Services;
...
namespace RoadshowShowcase
{
    ...
    {
        // This constant must match <UserSecretsId> value in RoadshowShowcase.csproj 
        public const string USER_SECRETS_ID = "RoadshowShowcase";
